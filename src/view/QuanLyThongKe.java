...
public class QuanLyThongKe extends JPanel {
    ...
    private JButton xemThongKe_jButton;
    ...
    private void initUI() {
        ...
        ResultSet allNamInPhieuNhapResultSet = ExcuteSQLStatement.ExcuteSQLQuery(getAllNamInPhieuNhap);
        try {
        ...
        ResultSet allThangInPhieuNhapResultSet = ExcuteSQLStatement.ExcuteSQLQuery(getAllThangInPhieuNhap);
        try {
        ...
        xemThongKe_jButton = new JButton();
    ...
    private int getCostByMonth(int month, int year) {
        ...
        ResultSet costResultSet = ExcuteSQLStatement.ExcuteSQLQuery(getCostStatetment);
        try {
    ...
    private int getIncomeByMonth(int month, int year) {
        ...
        ResultSet costResultSet = ExcuteSQLStatement.ExcuteSQLQuery(getIncomeStatement);
        try {
            while (costResultSet.next()) {
